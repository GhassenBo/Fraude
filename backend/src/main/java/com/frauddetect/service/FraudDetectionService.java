...
public class FraudDetectionService {
    ...
    public AnalysisResult analyze(MultipartFile file, User user) throws Exception {
        ...
        // La provenance du net a payer est transmise explicitement. Sans elle,
        // l'appel retombait sur la surcharge par defaut, qui declare le montant
        // non fiable : le net extrait visuellement n'etait jamais utilise, et
        // les controles qui en dependent — dont la comparaison au net social,
